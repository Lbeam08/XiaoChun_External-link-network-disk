...
?>
                <div class="list-group-item list-group-item-info text-center">系统检测到你已安装过小纯Res 外链网盘</div>
...
?>
            ...
            <footer class="footer">
            <pre><center>Powered by <a href="https://lxc.life" target="_blank">小纯Res </a> !</center></pre>
            </footer>
        </div>
    </div>
</div>
