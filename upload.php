...
<?php }else{?>
         <button id="uploadFile" class="btn btn-raised btn-primary" style="height:50px;font-size:20px;background: linear-gradient(294deg, #0ebeff, #ffa2da)" @click="clickUpload"><i class="fa fa-upload"></i> 选择文件<div class="ripple-container"></div></button>
<?php }?>
...
<div class="panel-heading" style='background-color: #ff8080'>
