...
<div class="panel-heading" style='background: linear-gradient(294deg, #0ebeff, #ffa2da)'>
...
<head>
    <style>
      /* 添加背景颜色效果 */
.btn.btn-primary.btn-raised.copy-btn {
  background: linear-gradient(131deg, #0ebeff, #ffa2da)
}
